...
TOTAL_ESPERADO_1 = 59_500     # 10_000 * 5 * 1.19
TOTAL_ESPERADO_2 = 23_800     # 5_000 * 4 * 1.19
TOTAL_ESPERADO_3 = 18_900     # 6_000 * 3 * 1.05
...
class Pruebas(unittest.TestCase):
    ...
    def test_normal_1(self):
        _, _, total = calcular(VALOR_PRODUCTO_1, CANTIDAD_1, IMPUESTO_19)
        self.assertAlmostEqual(total, TOTAL_ESPERADO_1, places=0)

    def test_normal_2(self):
        _, _, total = calcular(VALOR_PRODUCTO_2, CANTIDAD_2, IMPUESTO_19)
        self.assertAlmostEqual(total, TOTAL_ESPERADO_2, places=0)

    def test_normal_3(self):
        _, _, total = calcular(VALOR_PRODUCTO_3, CANTIDAD_3, IMPUESTO_5)
        self.assertAlmostEqual(total, TOTAL_ESPERADO_3, places=0)

    def test_extraordinario_1_impuesto_excesivo(self):
        with self.assertRaises(ErrorPorcentajeImpuestoInvalido):
            calcular(VALOR_PRODUCTO_EXTRA, CANTIDAD_EXTRA, 1.5)
